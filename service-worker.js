...
if (workbox) {
  ...
  precacheAndRoute([
    { url: '/', revision: '4.1.8' },
    { url: '/index.html', revision: '4.1.8' },
    { url: '/manifest.json', revision: '4.1.8' },
    { url: '/context/utils.js', revision: '4.1.8' },
    { url: '/context/btn-install.js', revision: '4.1.8' },
    { url: '/context/sw-registration.js', revision: '4.1.8' },
    { url: '/assets/icons/IBMty_Icon_32.png', revision: '4.1.8' },
    { url: '/assets/icons/IBMty_Icon_180.png', revision: '4.1.8' },
    { url: '/assets/icons/IBMty_Icon_192.png', revision: '4.1.8' },
    { url: '/assets/icons/IBMty_Icon_512.png', revision: '4.1.8' },
    { url: '/assets/icons/IBMty_Logo_Desktop.png', revision: '4.1.8' },
    { url: '/assets/icons/IBMty_Logo_Mobile.png', revision: '4.1.8' },
  ]);
  ...
  self.addEventListener('install', (event) => {
    console.log('SW: Instalando v4.1.8...');
