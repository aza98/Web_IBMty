document.addEventListener('DOMContentLoaded', function() {
    ...
    var COPY = {
        ...
        denied: {
            wide: 'Bloqueadas — actívalas desde los ajustes de tu dispositivo',
            short: 'Bloqueadas',
    ...
    function render(s) {
        ...
        toggles.forEach(function(t) {
            ...
            t.btn.setAttribute(t.btn.getAttribute('role') === 'switch' ? 'aria-checked' : 'aria-pressed', s === 'granted' ? 'true' : 'false');
